...
public class BookServiceTest {
    ...
    @Test
    void searchByAuthor_found() {
        bookService.addBook("B001", "Clean Code", "Robert Martin", "111");
        assertEquals(1, bookService.searchByAuthor("Robert").size());
    }

    @Test
    void searchByAuthor_notFound() {
        bookService.addBook("B001", "Clean Code", "Robert Martin", "111");
        assertEquals(0, bookService.searchByAuthor("Unknown").size());
    }
}